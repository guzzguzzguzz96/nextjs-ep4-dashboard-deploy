...
function Content({ totalUsersData, totalPostsData }) {
  return (
    <div className="px-10 rounded-lg">
      ...
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic, aliquid, atque cumque blanditiis eaque eum quam unde, praesentium vitae porro quaerat? Veritatis deserunt placeat, totam eius fugit harum est eaque?
      </p>
    </div>
  );
}
